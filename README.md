...
git clone https://github.com/tu-usuario/dss-turban-model.git
cd dss-turban-model
2- Instalar dependencias:
Este proyecto requiere la librería pulp. Puedes instalarla usando pip:
pip install pulp
...
Z = c1x1 + c2x2
Basado en:
a11x1 + a12x2 <= Labor Disponible
a21x1 + a22x2 <= Presupuesto Disponible
x1 >= Mínimo CC-7,x2 >= Mínimo CC-8
